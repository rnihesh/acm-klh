    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 outline-none transition-all"
              >
            ...
            >
              <FileUp
                className={`w-8 h-8 mb-2 transition-colors ${dragOver === "gst" ? "text-blue-400" : "text-gray-500"}`}
              />
        ...
        <div className="bg-[#111827] rounded-xl border border-gray-800 p-6">
          ...
          >
            <FileUp
              className={`w-8 h-8 mb-2 transition-colors ${dragOver === "taxpayer" ? "text-blue-400" : "text-gray-500"}`}
            />
            <span className="text-sm text-gray-400">
              {dragOver === "taxpayer"
                ? "Drop files here"
      ...
      {/* Upload Progress */}
      {uploading && (
        <div className="flex items-center gap-3 p-4 mb-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
          <div className="animate-spin rounded-full h-5 w-5 border-2 border-blue-500 border-t-transparent" />
          <span className="text-sm text-blue-400">Processing upload...</span>
        </div>
      )}
